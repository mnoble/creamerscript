...
describe Creamerscript::Transformers::MethodInvocation do
  it "parses out the subject" do
    invocation = Creamerscript::Transformers::MethodInvocation.new "(this foo:bar)"
    invocation.subject.should == "this"
  end

  it "parses out the method name based on Signature Keys" do
    invocation = Creamerscript::Transformers::MethodInvocation.new "(this foo:bar and:baz with:barf)"
